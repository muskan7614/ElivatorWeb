...
const whatsappNumber = '+919354927034'; // Project's phone number
...
export const WhatsAppFloatingButton: React.FC = () => (
  <a
    ...
    className="fixed right-6 bottom-6 z-50 bg-green-500 hover:bg-green-600 rounded-full shadow-lg p-3 flex items-center justify-center transition-colors duration-200"
